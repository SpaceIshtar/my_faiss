...
// FAISS integration for alternative quantization methods
...
template <typename T, typename LabelT = uint32_t> class PQFlashIndex
{
  public:
    ...
    // FAISS quantization integration
    // Set a FAISS IndexFlatCodes to use for distance estimation instead of PQ.
